...
- (instancetype)initWithFrame:(CGRect)frame{
    ...
    if (self) {
        ...
        UIView *contentV = [[UIView alloc] initWithFrame:CGRectMake(0, APP_HEIGHT, APP_WIDTH, 220)];
        ...
        UIView *upVeiw = [[UIView alloc]initWithFrame:CGRectMake(0, 0, APP_WIDTH, 40)];
        ...
        self.titleL = [[UILabel alloc] initWithFrame:CGRectMake(CGRectGetMaxX(cancelButton.frame), 0, APP_WIDTH - 104, 40)];
        ...
        UIView *splitView = [[UIView alloc] initWithFrame:CGRectMake(0, 40, APP_WIDTH, 0.5)];
...
-(UIView*)pickerView:(UIPickerView *)pickerView viewForRow:(NSInteger)row forComponent:(NSInteger)component reusingView:(UIView *)view {
    ...
    UILabel*label=[[UILabel alloc]initWithFrame:CGRectMake(APP_WIDTH * component / 6.0, 0,APP_WIDTH / 6.0, 30)];
